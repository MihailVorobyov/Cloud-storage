...
- ls      возвращает список файлов и диреткорий в текущей директории;
- cd        (path | ~ | ..) изменяет текущую директорию (на указанную | на корневую | поднимает на один уровень вверх) и возвращает список файлов;
